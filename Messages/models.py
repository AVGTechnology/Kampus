...
class Feedback(models.Model):
    sender = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='sentby', on_delete=models.CASCADE)
    text = models.TextField(max_length=1000, verbose_name='feedback', default='write Feedback...', )
    timestamp = models.DateTimeField(auto_now_add=True, editable=False)

    def __str__(self):
        return f'Feedback from {self.sender}'
