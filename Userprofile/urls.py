...
urlpatterns = [
   # path("login/", views.login, name='login'),
    ...
    path("about_kampus/", views.about_kampus, name='about_kampus'),
    path("kampus/apps/", views.kampus_app, name='kampus_app'),
    ...
    path("profile/image/view/<int:pk>", views.profile_image_view, name='profile_image_view'),
]
